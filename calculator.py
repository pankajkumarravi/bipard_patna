...
if __name__ == "__main__": 
    ...
    TEST= Button(gui, text='NAMES', fg='black', bg='light green', 
                    command=lambda: press('PANKAJ,GARIMA,DIVANDANA'), height=1, width=7) 
    TEST.grid(row=6, column=1) 
    # start the GUI 
    gui.mainloop() 
